...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .objet-imu { font-family: 'Courier New', monospace; font-size: 10pt; color: #3B82F6; font-weight: 700; }
...
<body>
  ...
  <div class="objet-line">
    ...
    &nbsp;&nbsp;|&nbsp;&nbsp; IMU : <span class="objet-imu">${patient.imu}</span>
  </div>
  ...
  <div class="doc-footer">
    <span>Généré par MediLink — IMU : ${patient.imu} — ${new Date().toLocaleDateString("fr-FR")} ${new Date().toLocaleTimeString("fr-FR", { hour: "2-digit", minute: "2-digit" })}</span>
    ...
    return new NextResponse(html, {
      headers: {
        ...
        "Content-Disposition": `inline; filename="lettre-reference-${patient.imu}.html"`,
      },
    });
  } catch (error: unknown) {
