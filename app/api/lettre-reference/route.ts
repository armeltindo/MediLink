...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .logo { color: #0D7A5F; font-size: 18pt; font-weight: bold; text-align: right; }
...
<body>
  ...
  <div class="header">
    ...
    <div class="logo">MediLink<br><span style="font-size:10pt;font-weight:normal;color:#64748B;">DME Unifié</span></div>
  </div>
