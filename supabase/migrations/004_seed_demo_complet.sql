...
INSERT INTO patients (id, imu, nom, prenom, date_naissance, lieu_naissance, sexe, situation_matrimoniale,
  ...
  ('a1000000-0000-0000-0000-000000000001', 'IMU-2024-004821', 'AGOSSOU',  'Dossou Félix',      '1968-03-15', 'Parakou',        'M', 'marié',      3, 'A',  '+', 'Béninoise', 'Comptable',          'Licence', 'Français', 'Agossou Cécile',   'Épouse', '+229 97 11 22 33', 'CNSS',  'CNSS-2024-00981',  80.00, 'Cotonou',    '+229 97 21 22 23'),
  ('a1000000-0000-0000-0000-000000000002', 'IMU-2024-007340', 'HOUNSOU',  'Fatoumata',         '1985-07-22', 'Abomey-Calavi',  'F', 'mariée',     4, 'O',  '+', 'Béninoise', 'Infirmière libérale', 'BTS',     'Français', 'Hounsou Sébastien','Mari',   '+229 96 22 33 44', 'RAMU',  'RAMU-2023-05521',  75.00, 'Cotonou',    '+229 96 24 25 26'),
  ('a1000000-0000-0000-0000-000000000003', 'IMU-2024-009156', 'GARBA',    'Ibrahima',          '1952-11-08', 'Kandi',          'M', 'marié',      6, 'B',  '-', 'Béninoise', 'Retraité',            'Primaire','Français', 'Garba Aminata',    'Fille',  '+229 95 33 44 55', NULL,    NULL,               NULL,  'Parakou',    '+229 95 27 28 29'),
  ('a1000000-0000-0000-0000-000000000004', 'IMU-2025-001243', 'DOSSOU',   'Bernadette Aïkpe',  '1995-01-30', 'Cotonou',        'F', 'célibataire',1, 'AB', '+', 'Béninoise', 'Étudiante',           'Master',  'Français', 'Dossou Paul',      'Père',   '+229 97 44 55 66', 'CNSS',  'CNSS-2025-01102',  60.00, 'Cotonou',    '+229 97 30 31 32'),
  ('a1000000-0000-0000-0000-000000000005', 'IMU-2025-003877', 'LOKOSSOU', 'Koffi Emmanuel',    '2019-05-12', 'Porto-Novo',     'M', NULL,         0, 'O',  '+', 'Béninoise', NULL,                  NULL,      'Français', 'Lokossou Marie',   'Mère',   '+229 97 55 66 77', 'RAMU',  'RAMU-2025-00412',  100.00,'Porto-Novo',  '+229 97 55 66 77')
ON CONFLICT (id) DO NOTHING;
